...
async function syncGoogleSheet(triggeredBy, mode) {
  ...
  try {
    ...
    // Explicitly refresh the materialized view after the batch completes.
    // This replaces the noisy FOR EACH STATEMENT trigger that crashed concurrent chunk inserts.
    await supabase.rpc('refresh_item_stock_ledger');
